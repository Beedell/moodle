...
define(['jquery', 'core/svgjs'], function($, svgjs) {
    ...
    var t = {
         ...
         * @param config Array of topnode and maxsizes
         */
         ...
         * @param dropzoneNo
         * @param resizeno The current vertex or handle number.
         */
        addNewHandle: function(dropzoneNo, resizeno) {
            ...
            t.addDropzones();
            // $.when(t.addDropzones()).then(function() {
            //     t.shape[dropzoneNo].fire('click');
            // });
            //t.shape[dropzoneNo].fire('click');//TODO this fires too early, need to add a promise return from addDropzones.
        },
         ...
         * @returns object containing functions {file, name}
         */
