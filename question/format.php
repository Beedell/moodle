...
class qformat_default {
    ...
    protected function create_category_path($catpath, $lastcategoryinfo = null) {
        ...
        foreach ($catnames as $key => $catname) {
            if ($parent == 0) {
                ...
                if ($key == (count($catnames) - 1) && $lastcategoryinfo->info !== null && $lastcategoryinfo->info !== ""
                        && $category->info == "") {
     ...
     */
    public function create_dummy_question_representing_category($categoryname, $categoryinfo) {
