...
define(['jquery', 'core/autoscroll'], function($, autoScroll) {
    ...
    var t = {
         ...
         *
         * @public
         * @param event Event (should be either mousedown or touchstart)
         * @return Object with start (boolean flag) and x, y (only if flag true) values
         */
         ...
         * @public
         * @param event Event (should be either mousedown or touchstart)
         * @param dragProxy An absolute-positioned element for dragging
         * @param onMove Function that receives X and Y page locations for a move
         * @param onDrop Function that receives X and Y page locations when dropped
         */
         ...
         *
         * @private
         * @param pageX X co-ordinate
         * @param pageY Y co-ordinate
         */
